...
var file_listener_proto_rawDesc = []byte{
	...
	0x69, 0x6c, 0x74, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8f, 0x01, 0x0a, 0x08,
	...
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x70, 0x69, 0x78, 0x69, 0x75, 0x2e, 0x61, 0x70, 0x69,
	0x2e, 0x76, 0x31, 0x2e, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x43, 0x68, 0x61, 0x69, 0x6e, 0x52,
	0x0c, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x43, 0x68, 0x61, 0x69, 0x6e, 0x73, 0x62, 0x06, 0x70,
...
var file_listener_proto_goTypes = []interface{}{
	(*Listener)(nil),    // 0: pixiu.api.v1.Listener
	(*Address)(nil),     // 1: pixiu.api.v1.Address
	(*FilterChain)(nil), // 2: pixiu.api.v1.FilterChain
}
var file_listener_proto_depIdxs = []int32{
	1, // 0: pixiu.api.v1.Listener.address:type_name -> pixiu.api.v1.Address
	2, // 1: pixiu.api.v1.Listener.filter_chains:type_name -> pixiu.api.v1.FilterChain
